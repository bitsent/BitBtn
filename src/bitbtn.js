...
bitbtn = (function bitbtn() {
    ...
    var addCSS = (function () {
        ...
        var bitBtnStyle = ".bitbtn{cursor:pointer;display:inline-block;font-weight:400;text-align:center;vertical-align:middle;padding:.5em .75em;font-size:1em;line-height:1.5;border-radius:1.5em;border:.3em ridge}.bitbtn{position:relative;display:inline-block;color:#fff;background-color:#007bff;border-color:#0054ad}.bitbtn span{margin:0 .15em}@-webkit-keyframes bitbtn-spinner{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes bitbtn-spinner{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@-webkit-keyframes bitbtn-border-success{to{border-color:limegreen}}@keyframes bitbtn-border-success{to{border-color:limegreen}}@-webkit-keyframes bitbtn-border-error{to{border-color:pink}}@keyframes bitbtn-border-error{to{border-color:pink}}.bitbtn .status-circle{width:.8em;height:.8em;display:inline-block;vertical-align:text-bottom;border:.2em solid transparent;border-color:transparent;background-color:white;border-radius:50%;-webkit-animation:none;animation:none}.bitbtn .status-circle.loading{border:.2em solid currentColor;border-right-color:transparent;background-color:transparent;border-radius:50%;-webkit-animation:bitbtn-spinner .75s linear infinite;animation:bitbtn-spinner .75s linear infinite}.bitbtn .status-circle.success{border-color:transparent;background-color:rgb(163,252,30)}.bitbtn .status-circle.error{border-color:transparent;background-color:rgb(251,145,163)}.bitbtn .bitbtn-amount{font-size:1em;display:inline-block;background:#ffffff50;border-radius:10%;padding:0 3px}.bitbtn .bitbtn-not-work{background:#ddd;text-align:center;color:black;display:none;position:absolute;left:0;top:50px;padding:10px;width:100%}.bitbtn .bitbtn-not-work.show{display:block}.bitbtn .small-text,.bitbtn-modal-container .small-text{font-size:.6em}.bitbtn-modal-container{background-color:rgb(0,0,0);background-color:rgba(0,0,0,.4);position:fixed;left:0;top:0;width:100%;height:100%;display:none;z-index:1;padding-top:100px;overflow:auto}.bitbtn-modal-container .modal-content{background-color:#fefefe;margin:auto;border:1px solid #888;width:70%}.bitbtn-modal-container .modal-header{display:block;background-color:rgba(0,0,0,.1)}.bitbtn-modal-container .modal-header button{padding:10px;background-color:rgba(0,0,0,.1);border:0 none;margin:none}.bitbtn-modal-container .modal-header:hover button:hover{background-color:rgba(0,0,0,.3)}.bitbtn-modal-container .modal-header button.selected{background-color:rgba(0,0,0,.3)}.bitbtn-modal-container .modal-content .modal-body{padding:20px}.bitbtn-modal-container .close{color:#aaa;float:right;font-size:28px;font-weight:700}.bitbtn-modal-container .close:hover,.bitbtn-modal-container .close:focus{color:#000;text-decoration:none;cursor:pointer}.bitbtn-modal-container .qr-code-img img{display:block;padding:20px;width:auto;max-width:50%;margin:auto;margin-top:1em;margin-bottom:1em;border:1px solid black}.bitbtn-modal-container .wallet-list{list-style:none;display:flex;flex-wrap:wrap}.bitbtn-modal-container .wallet-list .wallet-item{display:inline-block;border:3px ridge black;padding:1em 2em;margin:3px;text-align:center}.bitbtn-modal-container .wallet-list .wallet-item:hover{background:-moz-linear-gradient(-45deg,rgba(150,200,200,0) 0%,rgba(150,200,200,1) 65%,rgba(150,200,200,0) 67%,rgba(150,200,200,0) 100%);background:-webkit-linear-gradient(-45deg,rgba(150,200,200,0) 0%,rgba(150,200,200,1) 65%,rgba(150,200,200,0) 67%,rgba(150,200,200,0) 100%);background:linear-gradient(135deg,rgba(150,200,200,0) 0%,rgba(150,200,200,1) 65%,rgba(150,200,200,0) 67%,rgba(150,200,200,0) 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#0096c8c8',endColorstr='#0096c8c8',GradientType=1)}.bitbtn-modal-container .wallet-list .wallet-item img{height:3em}";
    ...
    var supportedWalletsByOS = {
        ...
        // "bitcoin-out": {     // not implemented yet
        //     'Windows': [],
        //     'Android': [],
        //     'Open BSD': [],
        //     'Sun OS': [],
    ...
    var modalWindow = (function () {
        ...
        var altMessages = {
            "bitcoin": "Looks like you don't have any wallet that support 'BIP21' deep linking.",
            "bitcoin-out": "<TODO: Implement bitcoin-out>"
        };
        var altMessages_QR = {
            "bitcoin": "You appear to be on a desktop computer. Try scanning this QR code with a BitcoinSV wallet on your smartphone.",
            "bitcoin-out": "<TODO: Implement bitcoin-out>"
        };
    ...
    ensureParamsAreValid = (function () {
        ...
        function ensureParamsAreValid(params) {
            ...
            ensureBIP21_IsUsed_Only(params);
        ...
        function ensureBIP21_IsUsed_Only(params) {
            if (!("bip21" in params)) {
                params.bip21 = true;
            }
            ...
            if (params.bip21 !== true) {
                throw new Error("BitBtn supports only BIP21 (for now). bip21 cannot be false.");
            }
            if ("outputs" in params) {
                throw new Error("BitBtn supports only BIP21 (for now). Do not set the 'outputs' property");
            }
            if ("script" in params) {
                throw new Error("BitBtn supports only BIP21 (for now). Do not set the 'script' property");
            }
            if (!("amount" in params)) {
                throw new Error("BitBtn supports only BIP21 (for now). 'amount' property is required.");
            }
            if (typeof params.amount === "string") {
                params.amount = parseFloat(params.amount);
            }
            if (isNaN(params.amount) || params.amount <= 0) {
                throw new TypeError("BitBtn output amount must be a positive number!");
            }
        }
        ...
        function ensureOutputIsValid(output) {
            ...
            var price = getPrice(output.currency)
            ...
            if ("address" in output) {
                ...
                output.script = scripter.toAddress(output.address);
            }
            ...
            ensureScriptIsValid(output);
        }

        function ensureScriptIsValid(output) {
            output.script = output.script.toUpperCase();

            var parts = output.script.split(" ");
            for (var i = 0; i < parts.length; i++) {
                var part = parts[i].trim();

                if (part.replace(/\s/g, '').length < 1)
                    continue; // empty

                if (opcodes.indexOf(part) > -1)
                    continue;

                if (scriptData.test(part))
                    continue;

                throw new SyntaxError("BitBtn - Invalid script syntax in '" + part + "' : " + output.script);
            }
        }
    ...
    var scripter = (function () {
        ...
        function toAddress(address) {
            ...
            var resultScript = "OP_DUP OP_HASH160 " + pubHash160 + " OP_EQUALVERIFY OP_CHECKSIG";
            return resultScript;
        }
    ...
    function waitForPayment(btn) {
        ...
        btn.showLoadingInCircle();
        throw new Error("BitBtn 'waitForPayment' cannot be implemented for BIP21 transactions!")
