...
bitbtn = (function bitbtn() {
    ...
    var addCSS = (function () {
        ...
        var bitBtnStyle = ".bitbtn{cursor:pointer;display:inline-block;font-weight:400;text-align:center;vertical-align:middle;padding:0.5rem 0.75rem;font-size:1rem;line-height:1.5;border-radius:1.5rem;border:0.3rem ridge}.bitbtn{color:#fff;background-color:#007bff;border-color:#0054ad}.bitbtn span{margin:0 0.15rem}@-webkit-keyframes bitbtn-spinner{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes bitbtn-spinner{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@-webkit-keyframes bitbtn-border-success{to{border-color:limegreen}}@keyframes bitbtn-border-success{to{border-color:limegreen}}@-webkit-keyframes bitbtn-border-error{to{border-color:pink}}@keyframes bitbtn-border-error{to{border-color:pink}}.bitbtn .status-circle{width:0.8rem;height:0.8rem;display:inline-block;vertical-align:text-bottom;border:0.2em solid transparent;border-color:transparent;background-color:white;border-radius:50%;-webkit-animation:none;animation:none}.bitbtn .status-circle.loading{border:0.2em solid currentColor;border-right-color:transparent;background-color:transparent;border-radius:50%;-webkit-animation:bitbtn-spinner 0.75s linear infinite;animation:bitbtn-spinner 0.75s linear infinite}.bitbtn .status-circle.success{border-color:transparent;background-color:rgb(163, 252, 30)}.bitbtn .status-circle.error{border-color:transparent;background-color:rgb(251, 145, 163)}.bitbtn .bitbtn-amount{background:#ffffff50;border-radius:10%;padding:0 3px}.bitbtn .small-text,.bitbtn-modal-container .small-text{font-size:0.6rem}.bitbtn-modal-container{background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.4);position:fixed;left:0;top:0;width:100%;height:100%;display:none;z-index:1;padding-top:100px;overflow:auto}.bitbtn-modal-container .modal-content{background-color:#fefefe;margin:auto;border:1px solid #888;width:70%}.bitbtn-modal-container .modal-header{display:block;background-color:rgba(0, 0, 0, 0.1)}.bitbtn-modal-container .modal-header button{padding:10px;background-color:rgba(0, 0, 0, 0.1);border:0 none;margin:none}.bitbtn-modal-container .modal-header:hover button:hover{background-color:rgba(0, 0, 0, 0.3)}.bitbtn-modal-container .modal-header button.selected{background-color:rgba(0, 0, 0, 0.3)}.bitbtn-modal-container .modal-content .modal-body{padding:20px}.bitbtn-modal-container .close{color:#aaaaaa;float:right;font-size:28px;font-weight:bold}.bitbtn-modal-container .close:focus,.bitbtn-modal-container .close:hover{color:#000;text-decoration:none;cursor:pointer}.bitbtn-modal-container .qr-code-img img{display:block;padding:20px;width:auto;max-width:50%;margin:1rem auto;border:1px solid black}.bitbtn-modal-container .wallet-list{list-style:none;display:flex;flex-wrap:wrap}.bitbtn-modal-container .wallet-list .wallet-item{display:inline-block;border:3px ridge black;padding:1rem 2rem;margin:3px;text-align:center}.bitbtn-modal-container .wallet-list .wallet-item:hover{background:-moz-linear-gradient(-45deg, rgba(150,200,200,0) 0%, rgba(150,200,200,1) 65%, rgba(150,200,200,0) 67%, rgba(150,200,200,0) 100%);background:-webkit-linear-gradient(-45deg, rgba(150,200,200,0) 0%,rgba(150,200,200,1) 65%,rgba(150,200,200,0) 67%,rgba(150,200,200,0) 100%);background:linear-gradient(135deg, rgba(150,200,200,0) 0%,rgba(150,200,200,1) 65%,rgba(150,200,200,0) 67%,rgba(150,200,200,0) 100%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0096c8c8', endColorstr='#0096c8c8',GradientType=1 )}.bitbtn-modal-container .wallet-list .wallet-item img{height:3rem}";
